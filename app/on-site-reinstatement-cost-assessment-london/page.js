...
const included = [
  { label: 'Full physical site inspection', detail: 'A RICS surveyor visits and examines the building in person, inside and out, so nothing is assumed from records alone.' },
    ...
    <main>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <img fetchPriority="high" decoding="async"
          src="/on-site-reinstatement-cost-assessment-survey.webp"
      ...
      <section className="scroll-reveal py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-secondary leading-[1.75] text-[1.05rem]">
            ...
            <p>
              This level of detail matters most where a building is out of the ordinary, a listed
            ...
            <p>
              ...
              On the capital&rsquo;s harder buildings, it is that concentrated, specialist judgement, not
              general practice, that turns a careful inspection into a figure you can defend.
            </p>
          </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {whoNeedsIt.map(({ icon, title, desc }) => (
              <div key={title} className="gold-outline-shine flex flex-col gap-4 items-start rounded-2xl p-8" style={{ background: '#dcefe4' }}>
                <div className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0" style={{ background: '#1A6B4A' }}>
                  <span className="material-symbols-outlined text-white" style={{ fontSize: '1.6rem' }}>{icon}</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-1.5 leading-snug">{title}</h3>
                  <p className="text-secondary leading-relaxed text-[0.95rem]">{desc}</p>
      ...
      <section className="scroll-reveal py-24 px-6" style={{ background: '#0b5d3b' }}>
        <div className="max-w-4xl mx-auto flex flex-col gap-10">
          <div className="gold-outline-shine rounded-2xl">
            <Image width={1200} height={560} sizes="(max-width: 640px) 100vw, 1200px" src="/on-site-why-it-matters.webp" alt="RICS surveyor inspecting a building on site" className="w-full h-72 sm:h-[440px] rounded-2xl object-cover" />
          </div>
          <div>
          ...
          <div className="space-y-6 text-white/85 leading-[1.75] text-[1.05rem]">
            <p>
              London holds some of the most complex building stock in the country, Georgian and Victorian
            ...
            <p>
              Underinsurance on a high‑value asset is a serious exposure, and it is the norm, not the exception.
      ...
      <section className="scroll-reveal py-24 px-6" style={{ background: '#0b5d3b' }}>
        <div className="max-w-4xl mx-auto flex flex-col gap-10">
          <div className="gold-outline-shine rounded-2xl">
            <Image width={1200} height={560} sizes="(max-width: 640px) 100vw, 1200px" src="/on-site-coverage-london.webp" alt="Period red-brick London mansion block" className="w-full h-72 sm:h-[440px] rounded-2xl object-cover" />
          </div>
          <div>
          ...
          <p className="text-white/85 leading-relaxed mb-8 max-w-2xl text-[1.05rem]">
            ...
            cities and towns within easy reach of London, including Birmingham, Bristol, Manchester,
            Liverpool, Leeds, Cambridge and Oxford, wherever a building&rsquo;s complexity or value calls for
