      ...
      <section className="scroll-reveal py-24 px-6 bg-[#0f3d28]">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white leading-tight">For owners who never want to fall behind.</h2>
          </div>
            ...
            {whoNeedsIt.map(({ icon, title, desc }) => (
              <div key={title} className="flex gap-5 items-start bg-white/[0.04] rounded-2xl p-6 border border-white/10">
                <div className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-amber-300" style={{ fontSize: '1.3rem' }}>{icon}</span>
                </div>
                <div>
