          ...
          <div className="relative">
            <div className="reviews-track flex gap-6 w-max animate-scroll-reviews">
              {[
                ...
                { stars: 4, text: "Saved us over £80,000 on the dilapidations claim. The expertise here is genuinely exceptional.", name: "David C.", role: "Commercial Tenant", initials: "DC", color: "bg-emerald-600", google: true },
                ...
                { stars: 5, text: "Fast turnaround, clear report, and happy to talk through the findings the same day. Really helpful.", name: "Robert O.", role: "Property Developer", photo: "https://randomuser.me/api/portraits/men/75.jpg", google: true },
                ...
                { stars: 5, text: "Report came in ahead of schedule. Several issues flagged that changed our offer entirely.", name: "Priya S.", role: "Buy-to-Let Investor", photo: "https://randomuser.me/api/portraits/women/55.jpg", google: true },
