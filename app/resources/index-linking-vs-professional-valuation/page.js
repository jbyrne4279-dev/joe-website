  ...
  return (
    <main className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2 mb-6 leading-tight">Index Linking vs Professional Valuation: What Managing Agents Need to Know.</h1>
          <p className="text-gray-500 text-lg leading-relaxed">Many managing agents assume that because their insurer applies annual index linking, their buildings are adequately insured. This assumption is one of the most common and most expensive misunderstandings in UK property management.</p>
        </div>
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed">
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">What Is Index Linking?</h2>
            ...
            <p>In practice, the insurer applies a percentage uplift, say 5%, to the existing declared value. No surveyor visits the property. No detailed assessment is carried out. The insured figure simply grows by a fixed multiplier based on a broad market index.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Why Index Linking Alone Isn&rsquo;t Sufficient.</h2>
            <p className="mb-4">Index linking has one fundamental limitation: it adjusts an existing figure. If that figure was wrong to begin with, index linking makes it slightly less wrong each year, but never correct.</p>
            <ul className="space-y-2 list-disc pl-6">
              <li><strong className="text-gray-700">It doesn&rsquo;t account for building changes.</strong> Extensions, refurbishments, cladding replacement, new plant. None of these are captured by an index.</li>
              <li><strong className="text-gray-700">It uses broad national data.</strong> Regional labour costs can diverge significantly from a national index, particularly in London and the South East.</li>
              <li><strong className="text-gray-700">It ignores specialist construction.</strong> Listed buildings, non-standard construction, complex M&amp;E. All carry rebuild cost profiles that generic indices cannot model.</li>
              <li><strong className="text-gray-700">It compounds errors.</strong> A figure that was 15% too low in 2018 is still roughly 15% too low in 2024, regardless of how many times it has been uplifted.</li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">BCIS vs Generic CPI.</h2>
            <p>It is worth noting that not all indices are equal. Some insurers use general CPI as their index-linking basis, which tracks consumer price inflation, not construction cost inflation. These two measures can diverge significantly. Between 2020 and 2023, construction cost inflation substantially outpaced CPI in the UK, meaning that any policy index-linked to CPI over this period is likely to have fallen materially behind actual rebuild cost increases.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">The RICS Position.</h2>
            <p>RICS is unambiguous: index linking is a maintenance tool, not an assessment. Their guidance recommends a full professional reinstatement cost assessment every three years as a minimum, with index linking used only as an interim adjustment between assessments. This position is shared by the ABI and most major brokers.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">The Practical Recommendation for Managing Agents.</h2>
            <ul className="space-y-2 list-disc pl-6">
        ...
        <div className="mt-12 bg-white border border-gray-200 shadow-sm rounded-2xl p-8 text-center">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Need a reinstatement assessment?</h3>
