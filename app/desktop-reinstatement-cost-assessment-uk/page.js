...
export default function DesktopAssessmentUKPage() {
  return (
    ...
    <main>
      ...
      <section className="scroll-reveal py-24 px-6" style={{ background: '#10265c' }}>
        <div className="max-w-4xl mx-auto flex flex-col gap-10">
          <img width={1200} height={560} loading="lazy" decoding="async" src="/uk-coverage-map.jpg" alt="Map of the United Kingdom" className="w-full h-72 sm:h-[420px] rounded-2xl object-contain bg-white p-4 border border-black/5" />
          <div>
