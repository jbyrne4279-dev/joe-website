...
export default function ArticlePage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <h1 className="text-4xl font-bold text-primary mt-2 mb-6 leading-tight">Case Study: Block of Flats Undervalued by £2 Million</h1>
      <p className="text-secondary text-lg leading-relaxed mb-8">A managing agent instructed us to carry out a reinstatement cost assessment on a 24-unit residential block in the South East ahead of the annual renewal. What they found was significantly more serious than expected.</p>
      ...
      <div className="bg-[#0f3d28] rounded-2xl p-8 text-center">
        ...
        <p className="text-white/60 mb-5 text-sm">Send us your portfolio schedule and we&rsquo;ll identify which properties are overdue   for free.</p>
