      ...
      <section className="py-20 px-8 bg-zinc-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary max-w-xl mx-auto">A no-obligation review of your portfolio against current RICS reassessment guidance.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={title} className="liquid-glass rounded-2xl p-7 border border-[#1A6B4A]/15 sovereign-shadow text-center">
      ...
      <section className="py-20 px-8 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 mb-12">
            {[
              ...
              <div key={n} className="flex gap-5 items-start">
                ...
                <div className="liquid-glass flex-1 rounded-2xl p-5 border border-[#1A6B4A]/15">
          ...
          <div className="bg-[#0f3d28] rounded-2xl p-8 text-center">
            ...
            <p className="text-white/60 mb-6">Get in touch and we&rsquo;ll take it from there.</p>
            <Link href="/contact#contact-form" className="btn-shine text-white px-8 py-4 rounded-full font-bold inline-block mb-4">Request Your Free Review</Link>
            <p className="text-white/40 text-sm">Or email your schedule directly to <a href="mailto:info@rca-ltd.com" className="text-white/60 underline">info@rca-ltd.com</a></p>
          </div>
        </div>
      </section>
