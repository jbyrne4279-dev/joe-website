export default function FaqSection({ description, items }) {
  return (
    <section className="py-20 my-16 mx-4 md:mx-8 bg-surface-container-low rounded-3xl">
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {items.map((item, i) => (
            ...
            >
              <h3 className="text-base font-bold text-primary leading-snug">{item.question}</h3>
              <div>
