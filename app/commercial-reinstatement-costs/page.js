        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.5fr_1fr] gap-14 lg:gap-20 items-center">
          <div>
            ...
            <div className="space-y-6 text-secondary leading-[1.75] text-[1.05rem]">
              <p>
                It&rsquo;s the cost of rebuilding your property from scratch, the structure, the
              ...
              <p>
                ...
                <Link href="/building-reinstatement-cost" className="text-[#1A6B4A] underline underline-offset-2 hover:text-[#0f3d28]">building reinstatement cost</Link>. The difference for commercial property is scale, construction type and the specialist
