...
export default function ArticlePage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-secondary text-lg leading-relaxed mb-8">Research consistently shows that the majority of UK commercial and residential blocks carry insufficient reinstatement values on their insurance policies. For managing agents, this isn&rsquo;t just a problem for property owners   it creates direct professional and financial risk.</p>

      <h2 className="text-2xl font-bold text-primary mb-3">1. Proportional Settlement Under the Average Clause</h2>
      <p className="text-secondary leading-relaxed mb-6">Most commercial building insurance policies include an average clause, which means that if a property is underinsured, the insurer will reduce any claim payout in proportion to the shortfall. If a block has a true reinstatement value of £4 million but is insured for £2.8 million, it is 30% underinsured. A £600,000 claim would be settled at just £420,000. The remaining £180,000 falls on the freeholder and, ultimately, the leaseholders.</p>

      <h2 className="text-2xl font-bold text-primary mb-3">2. Personal Liability for Managing Agents</h2>
      <p className="text-secondary leading-relaxed mb-6">ARMA guidance and general professional duty of care obligations place a responsibility on managing agents to ensure that block insurance is adequate. Where a managing agent has been on notice that a valuation is outdated   or has simply allowed years to pass without recommending a reassessment   they may face claims from leaseholders following an underinsured loss. This is an increasingly litigated area.</p>

      <h2 className="text-2xl font-bold text-primary mb-3">3. Insurer Challenges at Renewal</h2>
      <p className="text-secondary leading-relaxed mb-6">Insurers are becoming more rigorous at renewal, particularly on blocks where the declared sum insured has not been supported by a professional assessment within the last three years. Queries, referrals, and potential policy voidance are real risks where no RICS-regulated assessment can be produced on request.</p>
      ...
      <p className="text-secondary leading-relaxed mb-8">Studies from BCIS and the ABI have indicated that average underinsurance across UK blocks runs at between 20% and 40% of true reinstatement value. On a £5 million block, that is a £1 million to £2 million exposure that leaseholders and managing agents may be unaware of.</p>

      <h2 className="text-2xl font-bold text-primary mb-3">How to Mitigate the Risk</h2>
      <ul className="list-disc list-inside text-secondary space-y-2 mb-10 leading-relaxed">
      ...
      <div className="bg-[#0f3d28] rounded-2xl p-8 text-center">
        ...
        <p className="text-white/60 mb-5 text-sm">We offer a free portfolio review   send us your schedule and we&rsquo;ll identify which buildings are overdue.</p>
