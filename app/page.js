        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="relative">
            ...
            <div className="reviews-track flex gap-6 w-max animate-scroll-reviews">
              {[
                { stars: 5, text: "Found serious damp the estate agent had glossed over completely. Saved us from a very costly mistake.", name: "James H.", role: "Homebuyer, London", photo: "https://randomuser.me/api/portraits/men/32.jpg" },
                ...
                { stars: 4, text: "Saved us over £80,000 on the dilapidations claim. The expertise here is genuinely exceptional.", name: "David C.", role: "Commercial Tenant", initials: "DC", color: "bg-emerald-600" },
                { stars: 5, text: "They made the whole thing simple. Clear, patient, and never made me feel out of my depth.", name: "Emma T.", role: "First-Time Buyer, Mayfair", photo: "https://randomuser.me/api/portraits/women/68.jpg" },
                { stars: 5, text: "Fast turnaround, clear report, and happy to talk through the findings the same day. Really helpful.", name: "Robert O.", role: "Property Developer", photo: "https://randomuser.me/api/portraits/men/75.jpg" },
                { stars: 5, text: "Flagged structural movement nobody else had spotted. We knocked £35k off the asking price.", name: "Claire S.", role: "Residential Buyer, Chelsea", photo: "https://randomuser.me/api/portraits/women/21.jpg" },
                { stars: 4, text: "Brilliant across our whole portfolio. Commercially sharp and technically rigorous — exactly what we need.", name: "Tom B.", role: "Asset Manager", initials: "TB", color: "bg-indigo-600" },
                { stars: 5, text: "Report came in ahead of schedule. Several issues flagged that changed our offer entirely.", name: "Priya S.", role: "Buy-to-Let Investor", photo: "https://randomuser.me/api/portraits/women/55.jpg" },
