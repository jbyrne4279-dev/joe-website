        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.5fr_1fr] gap-14 lg:gap-20 items-center">
          <div>
            ...
            <div className="space-y-6 text-secondary leading-[1.75] text-[1.05rem]">
              <p>
                It&rsquo;s the cost of rebuilding the whole block from scratch, structure, fees,
              ...
              <p>
                ...
                insured is too low, a claim is cut by the same proportion, and that shortfall lands on
