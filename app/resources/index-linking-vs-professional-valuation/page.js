...
export default function ArticlePage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-secondary text-lg leading-relaxed mb-8">Many managing agents assume that because their insurer applies annual index linking, their buildings are adequately insured. This assumption is one of the most common — and most expensive — misunderstandings in UK property management.</p>
