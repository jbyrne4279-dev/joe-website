  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold text-primary mt-2 mb-6 leading-tight text-center">Index Linking vs Professional Valuation   What Managing Agents Need to Know</h1>
        <p className="text-secondary text-lg leading-relaxed mb-8 text-center">Many managing agents assume that because their insurer applies annual index linking, their buildings are adequately insured. This assumption is one of the most common   and most expensive   misunderstandings in UK property management.</p>
      </div>

      <h2 className="text-2xl font-bold text-primary mb-3 text-center">What Is Index Linking?</h2>
      <p className="text-secondary leading-relaxed mb-6 text-center">Index linking is a mechanism used by insurers to automatically adjust the sum insured each year in line with a construction cost index   typically a variant of the BCIS All-in Tender Price Index or a proprietary equivalent. The intention is to prevent a building from drifting into underinsurance due to general cost inflation.</p>
      <p className="text-secondary leading-relaxed mb-8 text-center">In practice, the insurer applies a percentage uplift   say 5%   to the existing declared value. No surveyor visits the property. No detailed assessment is carried out. The insured figure simply grows by a fixed multiplier based on a broad market index.</p>

      <h2 className="text-2xl font-bold text-primary mb-3 text-center">Why Index Linking Alone Isn&rsquo;t Sufficient</h2>
      <p className="text-secondary leading-relaxed mb-4 text-center">Index linking has one fundamental limitation: it adjusts an existing figure. If that figure was wrong to begin with, index linking makes it slightly less wrong each year   but never correct.</p>
      ...
      <div className="bg-[#0f3d28] rounded-2xl p-8 text-center flex flex-col items-center">
        <h3 className="text-xl font-bold text-white mb-2 text-center">Need a reinstatement assessment?</h3>
        <p className="text-white/60 mb-5 text-sm text-center">RICS-regulated, BCIS-indexed, broker-ready. Delivered in 5 days.</p>
