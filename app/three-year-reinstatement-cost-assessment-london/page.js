  ...
  return (
    ...
    <main>
        ...
        <div className="relative z-10 w-full flex items-center justify-center px-6 py-24 md:py-32">
          <div className="w-full max-w-xl md:max-w-2xl bg-white/85 backdrop-blur-xl rounded-3xl px-8 py-12 md:px-14 md:py-16 border border-white/40 shadow-[0_8px_40px_rgba(0,0,0,0.2)] text-center">
            ...
            <p className="text-base text-secondary leading-relaxed mb-9 max-w-lg mx-auto">
              A full RICS rebuild cost assessment plus three years of BCIS‑indexed annual updates. Continuous compliance for London property owners, with no repeat instruction required.
            </p>
      ...
      <section className="scroll-reveal py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-secondary leading-[1.75] text-[1.05rem]">
            ...
            <p>
              Instead of relying on your insurer&rsquo;s generic index, or forgetting to review the figure
              at all, your London sum insured is professionally maintained throughout. You walk into every
            ...
            <p>
              ...
              assessment, and always by people who know your building.
            </p>
          </div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-5">
            {timeline.map(({ icon, label, title, desc }) => (
              <div key={label} className="gold-outline-shine flex flex-col sm:flex-row gap-4 sm:gap-6 sm:items-center bg-white rounded-2xl p-5 sm:p-6">
      ...
      <section className="scroll-reveal py-24 px-6" style={{ background: '#8a6800' }}>
        <div className="max-w-4xl mx-auto flex flex-col gap-10">
          <div className="gold-outline-shine rounded-2xl">
            <img width={1200} height={560} loading="lazy" decoding="async" src="/three-year-why-it-matters.jpg" alt="Surveyor maintaining a reinstatement cost figure" className="w-full h-72 sm:h-[440px] rounded-2xl object-cover" />
          </div>
          <div>
          ...
          <div className="space-y-6 text-white/85 leading-[1.75] text-[1.05rem]">
            ...
            <p>
              ...
              is re‑indexed against the latest BCIS data, keeping you continuously compliant and protecting
      ...
      <section className="scroll-reveal py-24 px-6" style={{ background: '#8a6800' }}>
        <div className="max-w-4xl mx-auto flex flex-col gap-10">
          <div className="gold-outline-shine rounded-2xl">
            <img width={1200} height={560} loading="lazy" decoding="async" src="/block-managers-london-flats.jpg" alt="Period London mansion block of flats" className="w-full h-72 sm:h-[440px] rounded-2xl object-cover" />
          </div>
          <div>
          ...
          <p className="text-white/85 leading-relaxed mb-8 max-w-2xl text-[1.05rem]">
            ...
            borough, ideal for agents and freeholders juggling multiple renewal dates.
          </p>
          </div>
        </div>
