        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="relative">
            ...
            <div className="reviews-track flex gap-6 w-max animate-scroll-reviews">
              {[
                { stars: 5, text: "Found serious damp the estate agent had glossed over completely. Saved us from a very costly mistake.", name: "James H.", role: "Homebuyer, London", initials: "JH", color: "bg-blue-500" },
                { stars: 5, text: "Used them across three acquisitions now. Always reliable, always thorough. A real trusted partner.", name: "Sarah M.", role: "Portfolio Landlord", initials: "SM", color: "bg-rose-500" },
                { stars: 4, text: "Saved us over £80,000 on the dilapidations claim. The expertise here is genuinely exceptional.", name: "David C.", role: "Commercial Tenant", initials: "DC", color: "bg-emerald-500" },
                { stars: 5, text: "They made the whole thing simple. Clear, patient, and never made me feel out of my depth.", name: "Emma T.", role: "First-Time Buyer, Mayfair", initials: "ET", color: "bg-purple-500" },
                { stars: 5, text: "Fast turnaround, clear report, and happy to talk through the findings the same day. Really helpful.", name: "Robert O.", role: "Property Developer", initials: "RO", color: "bg-orange-500" },
                { stars: 5, text: "Flagged structural movement nobody else had spotted. We knocked £35k off the asking price.", name: "Claire S.", role: "Residential Buyer, Chelsea", initials: "CS", color: "bg-teal-500" },
                { stars: 4, text: "Brilliant across our whole portfolio. Commercially sharp and technically rigorous — exactly what we need.", name: "Tom B.", role: "Asset Manager", initials: "TB", color: "bg-indigo-500" },
                { stars: 5, text: "Report came in ahead of schedule. Several issues flagged that changed our offer entirely.", name: "Priya S.", role: "Buy-to-Let Investor", initials: "PS", color: "bg-pink-500" },
                ...
                <div key={i} className="flex-shrink-0 w-80 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
                  <div className="flex items-center gap-1 mb-3">
                    ...
                    <svg className="w-4 h-4 ml-auto text-[#4285F4]" viewBox="0 0 24 24" fill="currentColor"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
                  </div>
