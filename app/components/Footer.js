      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-14">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3.5 text-sm">
              <li><Link className="hover:text-emerald-400 transition-colors" href="/residential-reinstatement-cost-assessments">Residential Properties</Link></li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3.5 text-sm">
              ...
              <li><Link className="hover:text-emerald-400 transition-colors" href="/about">About</Link></li>
              <li><Link className="hover:text-emerald-400 transition-colors" href="/building-reinstatement-cost">Building Reinstatement Cost</Link></li>
