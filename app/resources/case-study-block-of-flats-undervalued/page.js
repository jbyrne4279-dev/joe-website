  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold text-primary mt-2 mb-6 leading-tight text-center">Case Study: Block of Flats Undervalued by &pound;2 Million</h1>
        <p className="text-secondary text-lg leading-relaxed mb-8 text-center">A managing agent instructed us to carry out a reinstatement cost assessment on a 24-unit residential block in the South East ahead of the annual renewal. What they found was significantly more serious than expected.</p>
      </div>
      ...
      <h2 className="text-2xl font-bold text-primary mb-3 text-center">The Outcome</h2>
      <p className="text-secondary leading-relaxed mb-10 text-center">The managing agent presented our RICS-regulated report to their broker the same day it was received. The broker submitted it directly to the insurer, who accepted the new figure without challenge and updated the policy at renewal. The freeholder and leaseholders were now adequately protected. Had a major claim occurred before this assessment, the shortfall would have fallen entirely on the building&rsquo;s residents.</p>

      <div className="bg-[#0f3d28] rounded-2xl p-8 text-center flex flex-col items-center">
        <h3 className="text-xl font-bold text-white mb-2 text-center">Is your block in the same position?</h3>
        <p className="text-white/60 mb-5 text-sm text-center">Send us your portfolio schedule and we&rsquo;ll identify which properties are overdue   for free.</p>
