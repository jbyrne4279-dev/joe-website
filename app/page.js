        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8">
          <div className="gold-outline-shine liquid-glass-dark text-center mb-16 space-y-4 max-w-2xl mx-auto rounded-3xl p-10 md:p-14 sovereign-shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-3">
              ...
              <UnderinsuredQuizButton className="bg-white/10 border border-white/25 text-white px-6 py-4 rounded-full font-semibold text-sm hover:bg-white/20 active:scale-[0.97] transition-all text-center inline-flex items-center justify-center gap-2 cursor-pointer" />
            </div>
